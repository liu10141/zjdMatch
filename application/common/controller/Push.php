    ...
    public function send($obj, $token)
    {
        ...
        $params =
            [
                ...
                'data' => [
                    'first' => ['value' => $obj["first"], 'color' => '#4A4A4A'],
                    'keyword1' => ['value' => $obj["keyword1"], 'color' => '#232426'],
                    'keyword2' => ['value' => $obj["keyword2"], 'color' => '#FF6C37'],
                    'keyword3' => ['value' => $obj["keyword3"], 'color' => '#FF6C37'],
                    'remark' => ['value' => $obj["remark"], 'color' => '#23D96E']
                ]
            ];
...
//        $signature = substr($string, 0, strlen($string) - 1);
        ...
        $appid = config('wxconfig.appid');//拍拍拍
        $signPackage = array(
            "appId" => $appid,
            "nonceStr" => $nonceStr,
            "timestamp" => $timestamp,
